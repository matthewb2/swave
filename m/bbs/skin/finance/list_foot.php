...
<td align="center" colspan="5"><? if($is_admin) {?><input type="checkbox" id='checkAll' onclick='check_all();' /><?}?>
  <input class="submit_button" align="center" style="width:99%; text-align:center; height:40px; margin:5px 0 5px 0" type="submit" value="새글쓰기" onclick='skin/doc/write.php'"></td>
</tr>
