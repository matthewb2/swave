...
<tr>
	<td width="150px"  onclick="window.location='view.php?id=<?=$id?>&no=<?=$data[no]?>'">
	&nbsp;		
			
		<?if ($data[file_name1]){
				echo "<img style='padding:0px' src='http://swave.woobi.co.kr/bbs/".$file_name1."'/>";
		}?>
	</td>
	<td style="vertical-align:middle; line-height:150%; border-bottom:1px solid #e1e1e1; height:60px; padding;0px; font-size:11pt; color:#000000" onclick="window.location='view.php?id=<?=$id?>&no=<?=$data[no]?>'">
		...
		<br><font size="2" color="#666666">&nbsp;&nbsp;&nbsp;&nbsp;조회: <?=$hit?>/ 추천: <?=$vote?></font>
	</td>
</tr>