<?php
	...
	$memo = str_replace("<table","<table class='wrap-table' width='100%'>",$memo);
...
if( $han_len > strlen($amemo)){
	
$lang = "ko-kr";
$amemo = mb_substr($amemo, 0, 500);
//echo $amemo;

} else {$lang = "ko-kr";

$amemo = substr($amemo, 0, 650);
	...
	<table border="0" width="100%">
		...
		<td width="100%">
		 <audio controls style="padding:5px 0 0 0;width:100%">
		  <source src="http://api.voicerss.org/?key=8fe803833a774b3e85ca68b6b0d49e73&src='<?=$amemo?>'&hl=ko-kr" type="audio/mpeg">
		 </audio> 
		</td>
		<td>
