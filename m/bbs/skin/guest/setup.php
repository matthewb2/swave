...
?>
<a href="http://www.ted.com"><img src="http://www.kwabe.co.kr/banner/ted2.jpg" /></a>

<table width="<?=$width?>" cellSpacing="0" cellpadding="0" border="0" style="table-layout: fixed">
	<colgroup><col><col width="161px"></colgroup>
	<tr>
	<td align="left" valign="bottom"><?=$a_member_memo?><span class="setupLogin">쪽지 </span></a><?=$a_member_modify?><span class="setupLogin">정보수정 </span></a><?=$a_login?><span class="setupLogin">로그인 </span></a><?=$a_logout?><span class="setupLogin">로그아웃 </span></a><?=$a_member_join?><span class="setupLogin">회원가입 </span></a><?=$a_setup?><span class="setupLogin">설정 </span></a><?=$memo_on_sound?></td>
	<td colspan=2 align="right"><div><? include "include/print_category.php"; ?></div></td>
	</tr>
</table>