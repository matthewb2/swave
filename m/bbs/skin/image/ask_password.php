...
<td align="right"><img onclick="history.back()" src="<?=$dir?>/images/btn_goback.gif" alt="돌아가기" style="cursor:pointer;margin: 0px 3px 0px 3px;" /><input style="width:70px" type="image" src="<?=$dir?>/images/btn_complete.gif" accesskey="s" onfocus="blur()" title="완료" /></td>
</tr>
</table>
</form>