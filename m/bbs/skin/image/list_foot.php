...
<a style='margin-top:3px;background: #28aadc;
    ...
    display: inline-block;' href='zboard.php?id=doc&page=$prev_page'>prev</a>";
	}
$a_next_page2 = "<a style='margin-top:3px;background: #28aadc;
    ...
    text-align: center;
    text-decoration: none;
    display: inline-block;' href='zboard.php?id=doc&page=$next_page'>next</a></td>";
...
if($page == $start_page+6){ 
	...
	if ($i == $page-$start_page){
		$print_page2.="<a style=' margin-top:3px;background: #00648c;
			...
			text-align: center;
			text-decoration: none;
			display: inline-block;' href='$PHP_SELF?id=$id&page=$move_page&search=$search'>$move_page</a>";
		}	else {
			if ($i==1){
...
<form method="get" name="search" action="write.php" onsubmit="return check_search_form(this)" />
...
<table border="0" width="100%" cellSpacing="0" cellpadding="0" border="0" style="table-layout: fixed">

<tr height="5px"><td colspan="5"></td></tr>
<colgroup><col width="100px"><col width="6px"><col><col width="6px"><col width="75px"></colgroup>
<tr>
<td align="center" colspan="5"><? if($is_admin) {?><input type="checkbox" id='checkAll' onclick='check_all();' /><?}?>
  <input class="submit_button" style="height:50px; width:99%" type="submit" value="새글쓰기" onclick='skin/doc/write.php'"></td>
</tr>
