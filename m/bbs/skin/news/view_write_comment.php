...
<form onsubmit="return checkComment();" method=post name=write action=comment_ok.php>
		...
		<input type="image" src="<?=$dir?>/images/btn_post_comment.gif" accesskey="s" style="margin-top: 5px; border:0; width:70px; margin-right: 5px;margin-bottom: 5px;" title="덧글등록" /></td>
		</tr>
		</table>
