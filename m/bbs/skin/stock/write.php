...
<tr>
	...
	<input name="submit" type="submit" style="padding: 5px; height:100%; width:100%; border: 1px solid #ddd;
...
if($( "#editor2" ).val() == ""){
	$( "#editor2" ).html("<p>개인 +- </span> 외국인 +-</span> 기관 +-</span>");
}
//$("#editor2").text="<p>개인 </p> <p>외국인 </p> <p>기관 </p>"; 
