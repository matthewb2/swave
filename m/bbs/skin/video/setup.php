...
<div style="margin:-15px 0 0 0; border-bottom: 1px solid #ddd;">
			<table width="100%" >
				<tr>
	...
	color: #767676;
	text-align:center;
	padding:10px;width: 16%"><a href="zboard.php?id=video&category=4">IT</a></td> 
					<td style="font-size: 13px;
	font-weight:bold;
	color: #767676;
	text-align:center;
	padding:10px;width: 16%"><a href="zboard.php?id=video&category=5">금융</a></td> 
					<td style="font-size: 13px;
	font-weight:bold;
	color: #767676;
	text-align:center;
	padding:10px;width: 16%"><a href="zboard.php?id=video&category=6">신소재</a></td> 
					<td style="font-size: 13px;
	font-weight:bold;
	color: #767676;
	text-align:center;
	padding:10px;width: 16%"><a href="zboard.php?id=video&category=7">우주</a></td> 
					<td style="font-size: 13px;
	font-weight:bold;
	color: #767676;
	text-align:center;
	padding:10px;width: 16%"><a href="zboard.php?id=video&category=8">의료</a></td>
				</tr>
			</table>
</div>
