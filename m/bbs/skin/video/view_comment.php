...
<div class="reply" id="IAMCOMMENT_<?=$c_data[no]?>" align="right" style="width:100%;">
	<div id="comment_<?=$c_data[no]?>">
		...
		<colgroup><col width="140px"><col><col width="140px"></colgroup>
		<tr style="height: 29px;">
			...
			<? } else { ?>
			<span id="deleteButton_<?=$c_data[no]?>"><?=$a_del?><img src="<?=$dir?>/images/delete_com_btn.gif" width="32px" height="21px" style="margin-top: 5px;margin-right: 2px;cursor:pointer" title="삭제하기" /></a></span>
			<? } ?></td>
		</tr>
		<tr>
		...
		<div style="font: 10pt 굴림; padding:5px; line-height:1.7em" id="commentContainer_<?=$c_data[no]?>"></div>
	</div>
</div>
