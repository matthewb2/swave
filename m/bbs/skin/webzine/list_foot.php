...
$PHP_SELF = "http://m.swave.woobi.co.kr/zboard/webzine";
...
<a style='margin-top:3px;background: #28aadc;
    ...
    display: inline-block;' href='zboard.php?id=webzine&category=$category&page=$prev_page'>prev</a>";
	}
$a_next_page2 = "<a style='margin-top:3px;background: #28aadc;
    ...
    text-align: center;
    text-decoration: none;
    display: inline-block;' href='zboard.php?id=webzine&category=$category&page=$next_page'>next</a></td>";
