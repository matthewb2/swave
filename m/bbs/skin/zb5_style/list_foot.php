...
";
	...
	$a_prev_page2 = "<table cellspacing=0 cellpadding=0 border=0 align=center><tr><td>
<a style='margin-top:0px;background: #28aadc;
	height:45px;width:35px;
...
$a_next_page2 = "<a style='margin-top:0px;background: #28aadc;
	height:45px;width:35px;
...
if($page == $start_page+6){ 
	$print_page2.="<a style='margin-top:0px;background: #00648c;
	height:45px;width:35px;
	border: 1px solid #00648c;
    color: white;
    padding: 10px 10px;
		...
		$print_page2.="<a style=' margin-top:3px;background: #00648c;
			...
			if ($i==1){
							...
							display: inline-block;' href='$PHP_SELF/$move_page/$category'>$move_page</a>";
									...
									$print_page2.="<a style=' margin-top:0px;background: #ffffff;
							height:45px;width:35px;
							border-right: 1px solid #00648c;
							border-top: 1px solid #00648c;
							border-bottom: 1px solid #00648c;
...
<td align="center" colspan="5"><? if($is_admin) {?><input type="checkbox" id='checkAll' onclick='check_all();' /><?}?>
  <input class="submit_button" align="center" style="width:99%; text-align:center; height:45px; margin:5px 0 5px 0" type="submit" value="새글쓰기" onclick='skin/doc/write.php'"></td>
</tr>
