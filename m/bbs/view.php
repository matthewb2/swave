...
function set_recent($name)
{
 $f="./viewednews.json";
                                        ...
                                        foreach ($temp as $index=>$v) {
										  ...
										  $new = array("name"=>$name,"Address"=>$value);
...
if ($_GET['id'] == "dic" || $_GET['mode'] == "write" || $_GET['mode'] == "modify"){
...
<div id='bottomMenu' style='position: fixed;
 ...
 <img style='border:none' id='top' src='images/arrow-up-128.gif' onclick='gototop();'>
</div>
<?
